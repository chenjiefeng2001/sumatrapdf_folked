...
enum {
    ...
    CmdToggleAntiAlias = 487,
    CmdToggleSmoothScroll = 488,
    CmdToggleScrollbarInSinglePage = 489,
    CmdToggleLazyLoading = 490,
    CmdToggleEscToExit = 491,
    CmdToggleReuseInstance = 492,
    CmdToggleChmUI = 493,
    CmdNone = 494,
