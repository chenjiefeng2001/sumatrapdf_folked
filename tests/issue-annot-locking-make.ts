...
function makePdfWithAnnotations(): Buffer {
  ...
  body[6] = enc(
    "<< /Type /Annot /Subtype /Highlight /Rect [72 680 200 695] /C [1 0.9 0] /P 3 0 R /QuadPoints [72 695 200 695 72 680 200 680] >>",
  );
  body[7] = enc(
    "<< /Type /Annot /Subtype /Text /Rect [450 700 480 730] /Contents (Page 1 comment) /C [1 0 0] /P 3 0 R >>",
  );
  body[8] = enc(
    "<< /Type /Annot /Subtype /Link /Rect [72 600 200 620] /Border [0 0 1] /Dest [9 0 R /XYZ 72 700 1] /P 3 0 R >>",
  );
  body[3] = enc(
  ...
  // --- Page 2 ---
  const p2c =
    "BT /F1 24 Tf 72 740 Td (Page 2 - Test) Tj ET\nBT /F1 12 Tf 72 700 Td (Highlight + link to page 3.) Tj ET";
  body[10] = enc(`<< /Length ${p2c.length} >>\nstream\n${p2c}\nendstream`);
  body[11] = enc(
    "<< /Type /Annot /Subtype /Highlight /Rect [72 680 300 695] /C [0 1 0.8] /P 9 0 R /QuadPoints [72 695 300 695 72 680 300 680] >>",
  );
  body[12] = enc(
    "<< /Type /Annot /Subtype /Link /Rect [72 600 200 620] /Border [0 0 1] /Dest [13 0 R /XYZ 72 700 1] /P 9 0 R >>",
  );
  body[9] = enc(
    "<< /Type /Page /Parent 2 0 R /MediaBox [0 0 612 792] /Resources << /Font << /F1 5 0 R >> >> /Contents 10 0 R /Annots [11 0 R 12 0 R] >>",
  );
  ...
  body[15] = enc(
    "<< /Type /Annot /Subtype /Text /Rect [72 650 102 680] /Contents (Page 3 comment) /C [0 0 1] /P 13 0 R >>",
  );
  body[13] = enc(
    "<< /Type /Page /Parent 2 0 R /MediaBox [0 0 612 792] /Resources << /Font << /F1 5 0 R >> >> /Contents 14 0 R /Annots [15 0 R] >>",
  );
