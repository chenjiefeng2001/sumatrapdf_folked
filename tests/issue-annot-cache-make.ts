...
function makePdf(): Buffer {
  ...
  // --- Page 1 content ---
  const p1c =
    "BT /F1 24 Tf 72 740 Td (Page 1 - Annot Test) Tj ET\n" +
  ...
  body[6] = enc(
    "<< /Type /Annot /Subtype /Highlight /Rect [72 685 200 700] /C [1 1 0] /P 3 0 R /QuadPoints [72 700 200 700 72 685 200 685] >>",
  );
  // StrikeOut
  body[7] = enc(
    "<< /Type /Annot /Subtype /StrikeOut /Rect [72 655 200 670] /C [1 0 0] /P 3 0 R /QuadPoints [72 670 200 670 72 655 200 655] >>",
  );
  // Underline
  body[8] = enc(
    "<< /Type /Annot /Subtype /Underline /Rect [72 625 200 640] /C [0 0 1] /P 3 0 R /QuadPoints [72 640 200 640 72 625 200 625] >>",
  );
  // Squiggly
  body[10] = enc(
    "<< /Type /Annot /Subtype /Squiggly /Rect [72 595 200 610] /C [0 1 0] /P 3 0 R /QuadPoints [72 610 200 610 72 595 200 595] >>",
  );
  // FreeText
  body[11] = enc(
    "<< /Type /Annot /Subtype /FreeText /Rect [72 540 300 575] /Contents (FreeText content) /C [0.8 0.8 1] /P 3 0 R >>",
  );
  // Line
  body[12] = enc("<< /Type /Annot /Subtype /Line /Rect [72 500 300 550] /L [72 510 280 540] /C [1 0 1] /P 3 0 R >>");
  // Text (sticky note)
  body[13] = enc(
    "<< /Type /Annot /Subtype /Text /Rect [400 540 430 570] /Contents (Note on page 1) /C [1 0 0] /P 3 0 R >>",
  );
  // Page 1 object
  body[3] = enc(
    "<< /Type /Page /Parent 2 0 R /MediaBox [0 0 612 792] /Resources << /Font << /F1 5 0 R >> >> /Contents 4 0 R /Annots [6 0 R 7 0 R 8 0 R 10 0 R 11 0 R 12 0 R 13 0 R] >>",
  );

  // --- Page 2 content ---
  const p2c =
    "BT /F1 24 Tf 72 740 Td (Page 2 - More Annots) Tj ET\n" +
    "BT /F1 12 Tf 72 700 Td (Highlight) Tj ET\n" +
  ...
  // --- Page 2 annotations ---
  body[15] = enc(
    "<< /Type /Annot /Subtype /Highlight /Rect [72 685 220 700] /C [0.9 1 0] /P 9 0 R /QuadPoints [72 700 220 700 72 685 220 685] >>",
  );
  ...
  body[18] = enc(
    "<< /Type /Annot /Subtype /FileAttachment /Rect [72 580 100 610] /C [0 0 1] /FS << /Type /Filespec /F (test.txt) >> /P 9 0 R >>",
  );
  // Page 2 object
  body[9] = enc(
    "<< /Type /Page /Parent 2 0 R /MediaBox [0 0 612 792] /Resources << /Font << /F1 5 0 R >> >> /Contents 14 0 R /Annots [15 0 R 16 0 R 17 0 R 18 0 R] >>",
  );
